...
* throws Exception
* */
public class DealBigPage implements Callable {
    // 代理服务器
    ...
    * */
        ...
        try {
            ...
            int statusCode = httpResp.getStatusLine().getStatusCode();
                //设置字节数
                    ...
                    //获取页面单位数量
                    Tools.getMultiResultsByOneXpathPattern(data,"UTF-8","//*[@class='list_ul']/li[1]/a[3]/@href",urls);
                    //为空则重新来
                    if(urls.size()==0) {
                        int i = 0;
                        while (true) {
                    ...
                    FileWriter fw=null;
                    File file=new File("D:/万方/url.txt");
            //循环传参
            for(String u:urls){
               /* DealOnePage db=new DealOnePage(u);
                db.call();*/
    ...
    private static void setHeaders(HttpRequestBase httpReq) {
        ...
        httpReq.setHeader("Host","s.g.wanfangdata.com.cn");
    ...
    * */
    ...
    /*public static void main(String[] args) {
        ...
        doGetRequest(url);
        System.out.println(url.substring(170));
