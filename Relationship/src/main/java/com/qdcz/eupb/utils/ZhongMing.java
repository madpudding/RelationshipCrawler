...
public class ZhongMing {
    ...
    public static void doRequest(HttpRequestBase httpReq) {
        ...
        try {
            ...
            //获取页面单位数量
            Tools.getMultiResultsByOneXpathPattern(data,"UTF-8","//*[@class='text-center mt20']/a/@href",urls);
            //为空则重新来
            if(urls.size()==0) {
                int i = 0;
                while (true) {
    ...
    private static void setHeaders(HttpRequestBase httpReq) {
        ...
        httpReq.setHeader("Referer","https://www.zhongmin.cn/travel/detail/ip8686_is1.html");
    ...
    public static void main(String args[]){
        String url="https://www.zhongmin.cn/company/list?sid=1&areacode=HPPLNG";
        doGetRequest(url);
    }
}
